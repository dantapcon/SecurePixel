    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      <header className="absolute top-0 left-0 w-full flex justify-between items-center px-8 py-4 bg-white shadow-sm">
        <div className="flex items-center space-x-2">
          {/* Aquí podrías poner el logo de SecurePixel */}
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md mt-20 md:mt-0">
        ...
        <p className="text-center text-gray-600 mb-8">
          Únete a nuestra plataforma de aprendizaje de ciberseguridad
        </p>
        ...
        <div className="text-center mt-4 text-sm">
          ...
          <Link href="/iniciosecion" className="text-blue-600 hover:underline">
            Inicia sesión aquí
          </Link>
        </div>
      </div>
